...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks and not motion_cooldown:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if index_tip_y < index_mcp_y and thumb_tip_y > index_mcp_y and pinky_tip_y > index_mcp_y:
                print("Pointing Up Detected")
                motion_cooldown = True
            
            # Fist Detection (All fingers curled)
            elif index_tip_y > index_mcp_y and thumb_tip_y > index_mcp_y and pinky_tip_y > index_mcp_y:
                print("Fist Detected")
                motion_cooldown = True
